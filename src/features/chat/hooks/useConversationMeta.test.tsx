...
function message(senderId: string, clientSentAt: number): Message {
  return { id: `m${clientSentAt}`, senderId, type: 'text', mediaUrl: null, mediaAspectRatio: null, durationMs: null, latitude: null, longitude: null, text: 'x', sentAt: clientSentAt, clientSentAt, pending: false };
}
